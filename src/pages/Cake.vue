    ...
    data() {
      return {
        ...
        dataList: [
          {
            // 场景贴图
            image: require("@/assets/image/Cake-ROOM1.jpg"),
            tipsList: [
              // 进入展厅
              {
          ...
          {
            // 场景贴图
            image: require("@/assets/image/Cake-ROOM2.jpg"),
            tipsList: [
              // 进入展厅
              {
                position: { x: -200, y: 20, z: 120 },
          ...
          {
            // 场景贴图
            image: require("@/assets/image/Cake-ROOM3.jpg"),
            tipsList: [
              // 进入展厅
              {
                position: { x: -200, y: 20, z: 120 },
          ...
          {
            // 场景贴图
            image: require("@/assets/image/Cake-ROOM4.jpg"),
            tipsList: [
              // 进入展厅
              {
                position: { x: -200, y: 20, z: 120 },
